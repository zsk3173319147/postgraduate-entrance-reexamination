...
- #### Can you explain any research or projects you have worked on in your undergraduate studies?
  ...
  >
  > I did a course project on natural language processing during my undergraduate studies, where I developed a Chinese novel continuation project based on GPT-2. The project aimed to generate continuous Chinese novel text that looked like it was written by a single person, using a pre-trained GPT-2 model. Through this project, I learned about the principles of the GPT-2 model, data preprocessing, model training, and text generation techniques.
